...
%               "constructW" to construct the W, or construct it by yourself.
%              W是权重矩阵，可以调用constructW构造，也可以自己构造
...
%%       fea = rand(50,70);
%       options = [];
%       options.Metric = 'Euclidean'; %这是什么
%       options.NeighborMode = 'KNN';
%       options.k = 5;
%       options.WeightMode = 'HeatKernel';
%       options.t = 5;
%       W = constructW(fea,options);
%       options.PCARatio = 0.99 %这是什么
