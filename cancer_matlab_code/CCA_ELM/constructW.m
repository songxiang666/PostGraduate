...
%                                       两个节点之间增加一条边当且仅当它们之间是k临近的
%                                       你应该提供一个k值，表示k参数的大小
%               'Supervised'      -  k = 0
%                                       Put an edge between two nodes if and
%                                       only if they belong to same class. 
%                                      k=0 时， 在两个节点之间增加一条边，当且仅当它们属于同一类
%                                    k > 0
...
%                          0. 
%                           只有在 'Supervised'才有效，如果=1，该图将构造为LPP与LDA相同，默认为0
